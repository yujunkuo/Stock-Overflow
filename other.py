...
def _get_technical_indicators_from_stock_id(stock_id: str) -> dict:
    try:
        # days = 360 時 Heroku 記憶體會爆掉
        r = requests.get(f"https://histock.tw/stock/chip/chartdata.aspx?no={stock_id}&days=200&m=dailyk,close,volume,mean5,mean10,mean20,mean60,mean120,mean5volume,mean20volume,k9,d9,rsi6,rsi12,dif,macd,osc")
